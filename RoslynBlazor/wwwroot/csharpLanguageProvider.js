async function sendRequest(type, request) {
    let endPoint;
    switch (type) {
        case 'complete': endPoint = 'http://localhost:5009/completion/complete'; break;
        case 'signature': endPoint = 'http://localhost:5009/completion/signature'; break;
        case 'hover': endPoint = 'http://localhost:5009/completion/hover'; break;
        case 'codeCheck': endPoint = 'http://localhost:5009/completion/codeCheck'; break;
    }
